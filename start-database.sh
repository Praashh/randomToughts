...
DB_CONTAINER_NAME="random-thoughts-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=random-thoughts -d -p 5432:5432 docker.io/postgres
